<%@ page language="java" import="java.util.*,java.io.*,com.test.util.*"
	...
	<%
		/* 1、设置支付密钥：从商户自服务系统获取 */
		String cpkey = "M0I4Q0EyNzk5NEEzM0VFOUJCNTE5MDU0NjMzRDA1NEFFRDYzMUQzQk1UWTFNVGcyTURFMk9ETXhPREE0T1RjNU9ETXJNVEU1T0RVd01qRXhOalV6TkRBNE1qYzNOekV4TWpreE1qZ3dNakkzT0RVNE1UWXdOVEkz";
