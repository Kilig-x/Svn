...
// 产品名称
String p5_Pid = new String(formatString(request.getParameter("p5_Pid")).getBytes("iso-8859-1"),"gbk");

// 产品类型
String p6_Pcat = new String(formatString(request.getParameter("p6_Pcat")).getBytes("iso-8859-1"),"gbk");

// 产品描述
String p7_Pdesc = new String(formatString(request.getParameter("p7_Pdesc")).getBytes("iso-8859-1"),"gbk");
